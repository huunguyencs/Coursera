...
public class Point implements Comparable<Point> {
    ...
    public static void main(String[] args) {
        ...
        // assert (Double.compare(p7.slopeTo(p8), Double.NEGATIVE_INFINITY) == 0) :
        // "Wrong value for degraded line";
        // assert (Double.compare(p4.slopeTo(p9), Double.POSITIVE_INFINITY) == 0) :
        // "Wrong value for vertical line";
        // assert (Double.compare(p4.slopeTo(p5), +0.0) == 0) : "Wrong value for
        // horizontal line";
        ...
        Point p = new Point(435, 346);
        Point q = new Point(435, 350);
